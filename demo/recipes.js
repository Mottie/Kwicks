...
ChiliBook.recipes[ "html.js" ] = 
{
	...
	, _main: {
		...
		, tag_start: { 
			...
			, _style: "color: #e9b96e; font-weight: bold;"
		} 
	...
	, tag_attrs: {
		...
		attr: {
			...
			, _style: { attr_name:  "color: #5b9fcf;", attr_value: "color: #ccc;" }
		}
	}
};
...
ChiliBook.recipes[ "js.js" ] = 
{
	...
	, _main: {
		...
		, statement: { 
			...
			, _style: 'color: #0080ff; font-weight: bold;'
		}
		, error: { 
...
ChiliBook.recipes[ "css.js" ] = 
{
	...
	, _main: {
		...
		, 'class': {
			  _match: /\.\w+/
			, _style: "color: #d3d7cf; font-weight: bold;"
		}
		, id:      {
			  _match: /#\w+/
			, _style: "color: #d46d09; font-weight: bold;"
		}
		, pseudo:  {
			  _match: /:\w+/
			, _style: "color: #CC9900;"
		...
		, element: {
			  _match: /\w+/
			, _style: "color: #caa352; font-weight: bold;"
		}
	}
	, definition: {
		  comment: { 
